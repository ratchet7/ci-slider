...
#PubGlobals.demsQuery(timestamp, placementmean,placementvar, user_id)
...
<form method="post" name="myform" action="treatment_description.py" onsubmit="sendSliderToForm(selfplaceslider.Value(), 'placementmean'); sendSliderToForm(varianceslider.Value(), 'placementvar')"; >




<p>Where would you place the <b><FONT COLOR=red>Republican</font> Party</b>?
<br/>
<br/>

<p> <b>First</b>, indicate your <b>best guess</b> by dragging the arrowhead labeled "Republican Party" to to a location on the slider. 

<p> <b>Second</b>, use the red circle to adjust the <b>answer range</b> so that you're
95 percent certain that the true ideology of the Republican Party is in the red range.
<br/>
<br/>


<p> Click Next when you're finished.
...
<script type="text/javascript">
 ...
 ilinerighttxt2 = b.create('text',[-28,-3.5, 'Liberal'], {fixed:true, fontSize:12});
  ...
  var selfplacelabel = b.create('text', [function(x){ return selfplaceslider.Value()-8;}, 4,'Republican Party'],
   {fontSize:14});
