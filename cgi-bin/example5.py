...
<form method="post" action="example6.py">

<p>This survey will ask you to place people on the slider. <br/> <br/>


<p>Here's what your answer would look like if your <b> best
guess was that a particular politician was somewhat liberal and you were 95 percent certain that the politician was between very liberal and moderate.
</b>
<br/>
<br/>
<p> This means that you believe there is only a <b>5 percent chance that the politician is more conservative than "moderate."</b>
<br/>
<br/>
Click Next.
 ...
 ilinerighttxt2 = b.create('text',[-28,-3.5, 'Liberal'], {fixed:true, fontSize:12});
  ...
  var selfplacelabel = b.create('text', [function(x){ return selfplaceslider.Value()-1.6;}, 4,'Politician'],
   {fontSize:14});
    ...
    var varianceslider = b.create('slider',[[63,-5],[63,5],[21,12.5,1]],
    {
