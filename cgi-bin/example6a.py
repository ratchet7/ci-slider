...
<form method="post" action="placeself.py">


<p>It's OK for the answer range to extend beyond the slider.  <br/><br/>
<p>Here's what your answer would look like if your <b> best
guess was that a politician was very liberal and you were 95 percent certain that the politican's true ideology ranged from somewhat liberal to \"even
 more liberal than very liberal.\"</b>
